...
def parse_commandline():
    ...
    # Config args group
    parser_config.add_argument("--ds_type", choices=["txt", "alpaca", "wizard30b", "wizard30b_uncensored", "airoboros", "llama2", "puffin", "gpt4all", "bluemoon"], default="alpaca", required=False,
